...
<style lang="postcss">
	...
	.track {
		@apply w-8 h-4 bg-gray-600 rounded-full shadow-inner;
	}

	.thumb {
		@apply transition-all duration-300 ease-in-out absolute top-0 left-0 w-4 h-4 bg-white border-2 border-gray-600 rounded-full;
	}
